...
// RESTAPIHandler provides a convenient interface for PaymentInvoice REST API handler.
type RESTAPIHandler struct {
	UseCase UseCaseHandler
}

// injectDeps inject the dependencies of the PaymentInvoice REST API handler.
...
// GetByID is the REST API handler for `GET /api/payment_invoices/{id}`.
...
// Get is the REST API handler for `GET /api/payment_invoices`.
...
// Create is the REST API handler for `POST /api/payment_invoices`.
...
// UpdateByID is the REST API handler for `PUT /api/payment_invoices/{id}`.
...
// PartiallyUpdateByID is the REST API handler for `PATCH /api/payment_invoices/{id}`.
...
// DeleteByID is the REST API handler for `DELETE /api/payment_invoices/{id}`.
